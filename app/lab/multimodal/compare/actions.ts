...
async function uploadFile(
  supabase: Awaited<ReturnType<typeof requireLabAdmin>>["supabase"],
  userId: string,
  file: File,
) {
...
export async function runMultimodalCompare(formData: FormData) {
  ...
  try {
    ...
    const enriched = { ...json, inputs: { a: { bucket: "lab-inputs", path: uploadA.path }, b: { bucket: "lab-inputs", path: uploadB.path } } };
